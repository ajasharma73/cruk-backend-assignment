...
const getTestContext = () =>
  ({
    ...
    memoryLimitInMB: '128',
    logGroupName:
      '/aws/lambda/DonationFunctionDeploy-DonationsFunctionRecruitmentStack',
    logStreamName: '2023/01/14/[$LATEST]1f6b7cb52ad9451cbaf0f2bee4b9ffa2',
    invokedFunctionArn:
      'arn:aws:lambda:us-east-1:582593384005:function:DonationFunctionDeploy-DonationsFunctionRecruitmentStack',
